...
public class AVLTree {
   ...
   public void insert( String newKey, Object newItem ) throws AVLException {
   ...
   private Node insertRec(Node currRoot, String newKey, Object newItem) throws AVLException {
      ...
      if(currRoot == null) {
         ...
         if( comparisonResult == 0 ) {
            ...
            throw new AVLException( "AVLTree: insert failed because input key is already in AVL tree!" );
         }
